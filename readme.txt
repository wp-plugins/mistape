=== Mistape ===
Tags: spell, spelling error, report error
...
On Ctrl+Enter event, plugin sends selected text along with paragraph and page URL it belongs to to an email address selected in admin settings page. You can choose among administrators and editors, or specify another address.
...
== Installation ==
Installation is simple and doesn't require any additional actions. You just:
1. Look up "Mistape" and and install it from plugins section of your site's admin area. Alternatively, you can download zip from WordPress.org Plugin Directory and extract its contents to wp-content/plugins directory.
